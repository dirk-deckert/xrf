...
\author{Pionus GmbH\\\texttt{deckert@pionus-solutions.de}}
\date{Version 1.0.2 (2026-02-22)}
...
\item The package warns if a label is redefined with a different value in the same run.
...
Remainder terms:
\remainl{r}{rem:eq1}, \remainl{r}{rem:eq2}, \remainl{r}{rem:eq3}.
...
Rendered output:
\begin{align*}
\terml{t:eq1-doc}\quad x + \namel{alpha-doc}{\alpha}y + \namel{beta-doc}{\beta}z &= \constl{c1-doc} + \remainl{r}{rem1-doc} \\
\terml{t:eq2-doc}\quad y + \namel{gamma-doc}{\gamma}z &= \constl{c2-doc} + \remainl{r}{rem2-doc} \\
\terml{t:eq3-doc}\quad z &= \constl{c3-doc} + \remainl{r}{rem3-doc}
\end{align*}

\begin{align*}
z &= \constr{c3-doc} + \remainr{r}{rem3-doc} \\
y &= \constr{c2-doc} + \remainr{r}{rem2-doc} - \namer{gamma-doc}(\constr{c3-doc} + \remainr{r}{rem3-doc}) \\
x &= \constr{c1-doc} + \remainr{r}{rem1-doc} - \namer{alpha-doc}(\constr{c2-doc} + \remainr{r}{rem2-doc}) + (\namer{alpha-doc}\namer{gamma-doc} - \namer{beta-doc})(\constr{c3-doc} + \remainr{r}{rem3-doc})
\end{align*}

\section{Label Interface}
These commands are exposed for direct label/value control:
\begin{itemize}
\item \cs{labelname\{label\}\{value\}} stores an arbitrary value (expanded at definition time).
\item \cs{labelnamenx\{label\}\{value\}} stores an arbitrary value without expansion.
